...
* **Homepage do Curso:** [https://castlab.org/courses/matd44/](https://castlab.org/courses/matd44/)
...
|**Aula**|**Data ou período de realização**|**Unidade Temática ou Conteúdo**|**Atividade/recurso**|
| :-: | :-: | :-: | :-: |
|1|01/10/2024|Revisão|  [[slides 1]](Aulas/Aula-01.pdf)    |
|2|03/10/2024|Experimentos aleatórios, espaço amostral, eventos. Coleção de eventos, funções indicadoras.|Quadro e/ou slides|
...
* James, B. (1981) Probabilidade: Um Curso em Nível Intermediário, IMPA. (Livro texto tentativo).
* Magalhães, M. N. (2004). Probabilidade e Variáveis Aleatórias. Ed. Universidade de São Paulo.
* Campos, M. A., Rêgo, L. C., & de Mendonça, A. F. (2017). Métodos probabilísticos e estatísticos com aplicações em engenharias e ciências exatas. Grupo Gen-LTC.
...
<!-- *** -->
O material de apoio será distribuído ao longo do curso. Esse material pode incluir, livros, slides de aula, scripts para reprodução, artigos científicos, artigos de divulgação, entre outros.
